...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        autoEncoderTest = new AutoEncoderTest();
		autoChooser = new SendableChooser();
		autoChooser.addDefault("Default Auto", new AutonomousCommand());
		autoChooser.addObject("Test Auto", new AutoEncoderTest());
    ...
    public void autonomousInit() {
        ...
        if (autoEncoderTest != null) autoEncoderTest.start();
    ...
    public void teleopInit() {
        ...
        if (autoEncoderTest != null) autoEncoderTest.cancel();
